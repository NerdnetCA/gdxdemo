...
public class SceneThree extends Scene implements BrucieListener {
    private static final String TAG = "SCENETHREE";
    ...
    public void show() {
        ...
        String fragmentShader = Gdx.files.internal("glsl/fragthree.fglsl").readString();
    ...
    public void render(float delta) {
        ...
        shaderProgram.setUniformf("brite", ampSlider.getValue());
        shaderProgram.setUniformf("gray", graySlider.getValue());
